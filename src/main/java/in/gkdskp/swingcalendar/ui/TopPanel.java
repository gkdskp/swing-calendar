...
public class TopPanel extends JPanel {
  ...
  TopPanel() {
	...
	newCalendarButton = new JButton();
	try{
		Image addImg = ImageIO.read(getClass().getResource("/add.png"));
		addImg = addImg.getScaledInstance(25, 25, Image.SCALE_DEFAULT);
		newCalendarButton.setIcon(new ImageIcon(addImg));
	} catch(Exception e) {
		e.printStackTrace();
	}
	newCalendarButton.setMargin(new Insets(0, 0, 0, 0));
	newCalendarButton.setBorder(null);
	newCalendarButton.setBackground(null);
